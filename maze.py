...
wall_11 = [1180, 0, 20, 950]
wall_12 = [850, 930, 330, 20]
...
def setup():
    global stage, coins, player, player_vx, player_vy, player_speed, goal, black_doors, collidables, doors_open, background_color, goal_color, black_door_color, black_switch_color, score 
...
while not done:
    ...
    ''' begin/end game text '''
    if stage == START:
        text1 = MY_FONT.render("MAZE", True, BLACK)
        ...
        screen.blit(text2, [410, 150])
        screen.blit(text3, [210, 200])
    elif stage == PLAYING:
